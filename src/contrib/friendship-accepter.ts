...
export function matchKeywordConfig (config: FriendshipAccepterConfig) {
...
export function doGreetingConfig (config: FriendshipAccepterConfig) {
...
export function FriendshipAccepter (
  ...
  const doGreeting   = doGreetingConfig(config)
  const isMatchKeyword = matchKeywordConfig(config)
